...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Image + text: Llama 4 Scout (17B, vision-capable)
    ...
    const systemMessage = {
      role: "system",
      content:
        "Your name is 'የመዳም ቅመም ነኝ'. You are the AI Assistant inside Yechalal Shop. " +
        "If asked your name, answer with 'የመዳም ቅመም ነኝ'. " +
